...
class VisitorReport extends StatefulWidget {
  const VisitorReport({Key? key, required this.c_email}) : super(key: key);

  final String c_email;
  @override
  State<VisitorReport> createState() => _VisitorReportState();
}

class _VisitorReportState extends State<VisitorReport> {
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text('Visitor Report :',style: TextStyle(fontSize: 13.64.sp,fontWeight:FontWeight.bold,color: Color.fromRGBO(12,25,71,1),decoration: TextDecoration.underline),overflow: TextOverflow.ellipsis,maxLines: 1),
