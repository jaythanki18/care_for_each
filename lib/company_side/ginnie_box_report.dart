...
class GinnieBoxReport extends StatefulWidget {
  const GinnieBoxReport({Key? key, required this.c_email}) : super(key: key);

  final String c_email;
  @override
  State<GinnieBoxReport> createState() => _GinnieBoxReportState();
}

class _GinnieBoxReportState extends State<GinnieBoxReport> {
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text('Ginnie Box Report :',style: TextStyle(fontSize: 13.64.sp,fontWeight:FontWeight.bold,color: Color.fromRGBO(12,25,71,1),decoration: TextDecoration.underline),overflow: TextOverflow.ellipsis,maxLines: 1),
