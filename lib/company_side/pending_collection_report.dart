...
class _PendingCollectionReportState extends State<PendingCollectionReport> {
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text('Pending Collection Report :',style: TextStyle(fontSize: 13.64.sp,fontWeight:FontWeight.bold,color: Color.fromRGBO(12,25,71,1),decoration: TextDecoration.underline),overflow: TextOverflow.ellipsis,maxLines: 1),
