...
class CollectionReport extends StatefulWidget {
  const CollectionReport({Key? key, required this.c_email}) : super(key: key);
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text('Collection Report :',style: TextStyle(fontSize: 13.64.sp,fontWeight:FontWeight.bold,color: Color.fromRGBO(12,25,71,1),decoration: TextDecoration.underline),overflow: TextOverflow.ellipsis,maxLines: 1),
